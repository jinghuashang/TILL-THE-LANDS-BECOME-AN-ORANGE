...
(() => {
  ...
  /* ---------------- 预设贴纸清单 ---------------- */
  // 贴纸素材托管于 https://ark-img.jinghuashang.cn/bc/（本地原件在 assets/png/bc/）
  // 新增方法：把素材上传到 CDN 对应路径，在 PRESETS 里加一行
  const PRESETS = [
    { src: 'https://ark-img.jinghuashang.cn/bc/tilte.webp',              name: '活动标题 · 直到大地变成一颗酸橙', scale: 62 },
    { src: 'https://ark-img.jinghuashang.cn/bc/anjielilaxiaor.webp',     name: '安洁莉娜 · 夏日装扮', scale: 62 },
    { src: 'https://ark-img.jinghuashang.cn/bc/anjielilafeix.webp',      name: '安洁莉娜 · 飞行', scale: 60 },
    { src: 'https://ark-img.jinghuashang.cn/bc/anjielilahenaicha.webp',  name: '安洁莉娜 · 喝奶茶', scale: 60 },
    { src: 'https://ark-img.jinghuashang.cn/bc/anjielilatantou.webp',    name: '安洁莉娜 · 探头', scale: 60 },
  ];
